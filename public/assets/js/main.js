 ...
 --------------------------------------------------------------*/
    ...
    function swiperInit() {
        ...
        if ($.exists(".ak-slider-2")) {
            const sliderEl = document.querySelector(".ak-slider-2");
            const slideCount = sliderEl.querySelectorAll(".swiper-slide").length;

            var swiper = new Swiper(".ak-slider-2", {
                loop: slideCount > 3, // ⭐ loop hanya kalau item > 3
                speed: 1000,
                autoplay: false,
                slidesPerView: "auto",
                spaceBetween: 30,
                ...
                navigation: {
                    nextEl: ".ak-swiper-button-next-2",
                    prevEl: ".ak-swiper-button-prev-2",
                },
            });
        }
            ...
            var swiper = new Swiper(".ak-slider-core-services", {
                ...
                pagination: {
                    ...
                    renderBullet: function (index, className) {
                        return '<h4 class=" feature-list ' + className + '">' + (index + 1) + text[index] + "</h4>";
                    },
                },
            });
        }
 ...
 --------------------------------------------------------------*/
    function modalVideo() {
        $(document).on("click", ".ak-video-open", function (e) {
            ...
            $(".ak-video-popup-container iframe").attr("src", `https://www.youtube.com/embed/${video}`);
...
--------------------------------------------------------------*/
 ...
 --------------------------------------------------------------*/
    if ($.exists(".food-menu-hr")) {
        ...
        let ak_menu_list_anim_2 = document.querySelectorAll(".food-menu-hr.style-1.anim-2");
        ...
        let ak_menu_list_anim_3 = document.querySelectorAll(".food-menu-hr.style-1.anim-3");
 ...
 --------------------------------------------------------------*/
    if ($.exists(".ak-menu-list-section-1")) {
        document.querySelectorAll(".ak-menu-list-section-1").forEach(function (elem) {
 ...
 --------------------------------------------------------------*/
    $(".ak-accordeon .ak-accordion-body")
        ...
        .prev()
        .on("click", function () {
            $(this).parents(".ak-accordeon").find(".ak-accordion-body").not(this).slideUp().prev().removeClass("active ak-icon");
            $(this).next().not(":visible").slideDown().prev().addClass("active ak-icon");
        });
 ...
 --------------------------------------------------------------*/
    ...
    if ($.exists(".increase-decrease")) {
        document.getElementById("increase").addEventListener("click", function () {
            var value = parseInt(document.getElementById("number-single-room").value, 10);
