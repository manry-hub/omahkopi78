        ...
        _createClass(_default, [
            ...
            },
            {
                ...
                value: function setScrollTo(event) {
                    ...
                    this.scrollTo(
                        event.currentTarget.getAttribute("data-".concat(this.name, "-href")) || event.currentTarget.getAttribute("href"),
                        event.currentTarget.getAttribute("data-".concat(this.name, "-offset"))
                    );
                },
            },
            {
            ...
            },
            {
                ...
                value: function addElements() {
                    ...
                    els.forEach(function (el, id) {
                        ...
                        var offset =
                            typeof el.dataset[_this3.name + "Offset"] === "string" ? el.dataset[_this3.name + "Offset"].split(",") : _this3.offset;
                ...
                value: function checkScroll() {
                    ...
                    if (forced || this.isScrolling || this.isDraggingScrollbar) {
                        ...
                        if (
                            ...
                            ((distance < 0.5 && this.instance.delta.y != 0) || (distance < 0.5 && this.instance.delta.y == 0))
                        ) {
                            this.stopScrolling();
                        }
                        ...
                        for (var i = this.sections.length - 1; i >= 0; i--) {
                            if (
                                ...
                                (this.instance.scroll.y > this.sections[i].offset && this.instance.scroll.y < this.sections[i].limit)
                            ) {
                        ...
                        if (current.sticky) {
                            if (current.inView) {
                                ...
                                if (
                                    ...
                                    _this8.instance.scroll.y < current.top - window.innerHeight / 2
                                ) {
                                    transformDistance = 0;
