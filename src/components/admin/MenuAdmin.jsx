export default function MenuAdmin({ menu = [] }) {
    ...
    return (
        <div className="dashboard-main-body">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
                <h6 className="font-semibold mb-0 dark:text-white">Kelola Menu</h6>
            </div>
                                                ...
                                                <tr key={item.id}>
                                                    ...
                                                    <td>
                                                        {item.menu_categories?.name ? (
                                                            <span className="text-neutral-500">{item.menu_categories?.name}</span>
                                                        ) : (
                                                    ...
                                                    <td>
                                                        {item.is_favorite ? (
                                                            <span className="badge text-success-700">Difavoritkan</span>
                                                        ) : (
                                                            <span className="badge text-success-400">Tidak</span>
                                                        )}
                                                    </td>
